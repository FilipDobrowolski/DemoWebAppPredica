...
namespace DemoAppPredica.Web.Extensions
{
    /// <summary>
    ...
    public class AzureAdOptions
    {
        ...
        /// <summary>
        /// Client Id (Application ID) of the DemoPredicaAppApiResourceId, obtained from the Azure portal for that application
        /// </summary>
        public string DemoPredicaAppApiResourceId { get; set; }

        /// <summary>
        /// Base URL of the DemoPredicaAppApiBaseAddress
        /// </summary>
        public string DemoPredicaAppApiBaseAddress { get; set; }
